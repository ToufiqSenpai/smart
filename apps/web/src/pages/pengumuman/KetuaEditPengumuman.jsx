...
export default function KetuaEditPengumuman() {
  ...
  return (
    <DashboardLayout>
      <button className="inline-flex items-center gap-2 text-text-secondary text-[13px] font-medium mb-6 hover:text-primary transition-colors cursor-pointer border-none bg-transparent font-sans" onClick={() => navigate("/kelola-pengumuman")}>
      ...
      <div className="bg-bg-card rounded-[20px] border border-border-subtle shadow-lux p-10">
        <div className="mb-8 pb-6 border-b border-border-subtle">
          ...
          <h2 className="font-grotesk text-2xl font-bold text-text-primary tracking-tight">Edit Pengumuman</h2>
          <p className="text-sm text-text-secondary mt-1">Ubah pengumuman untuk warga RT 08. Pengumuman dengan status <strong>Publik</strong> akan langsung terlihat oleh warga.</p>
        </div>
