    ...
    <DashboardLayout>
      ...
      <div className="bg-bg-card rounded-[20px] border border-border-subtle shadow-lux p-10">
        <div className="mb-8 pb-6 border-b border-border-subtle">
          ...
          <p className="text-sm text-text-secondary mt-1">Perbarui data usaha Anda dengan lengkap. Setelah disimpan, perubahan akan diverifikasi oleh Pengurus RT.</p>
        </div>
        ...
        <form noValidate>
          ...
          <div className="mb-6">
            ...
            <select className="w-full px-[14px] py-[10px] font-sans text-sm text-text-primary bg-bg-card border border-border-subtle rounded-[14px] outline-none transition-all focus:border-primary focus:shadow-[0_0_0_3px_var(--navy-brand-light)] placeholder:text-text-muted" id="jenisUsaha" defaultValue="Kuliner" required>
          ...
          <div className="mb-6">
            ...
            <input type="text" className="w-full px-[14px] py-[10px] font-sans text-sm text-text-primary bg-bg-card border border-border-subtle rounded-[14px] outline-none transition-all focus:border-primary focus:shadow-[0_0_0_3px_var(--navy-brand-light)] placeholder:text-text-muted" id="kontakUsaha" placeholder="Contoh: 081234567890 atau @warungsari" defaultValue="081234567890" required />
          ...
          <div className="mb-6">
            ...
            <div className="mt-4 block">
              <div className="flex items-center gap-4 px-4 py-3 bg-bg rounded-[14px] border border-border-subtle">
                <img className="w-[60px] h-[60px] rounded-[14px] object-cover bg-bg border border-border-subtle" src="https://placehold.co/60x60" alt="Preview" />
                <div className="flex-1">
                  <div className="text-[13px] font-semibold text-text-primary">warung-sari.jpg</div>
                  <div className="text-xs text-text-muted">1.2 MB</div>
                </div>
