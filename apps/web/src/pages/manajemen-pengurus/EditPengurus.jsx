    ...
    <DashboardLayout>
      ...
      <div className="bg-bg-card rounded-[20px] border border-border-subtle shadow-lux p-10">
        <div className="mb-8 pb-6 border-b border-border-subtle">
          ...
          <p className="text-sm text-text-secondary mt-1">Perbarui data kepengurusan RT 08.</p>
        </div>
        ...
        <form id="pengurusForm" noValidate>
          <div className="mb-6">
            ...
            <select className="w-full px-[14px] py-[10px] font-sans text-sm text-text-primary bg-bg-card border border-border-subtle rounded-[14px] outline-none transition-all focus:border-primary focus:shadow-[0_0_0_3px_var(--navy-brand-light)] placeholder:text-text-muted" id="wargaSelect" required value={form.warga} onChange={(e) => updateField("warga", e.target.value)}>
          ...
          <div className="mb-6">
            ...
            <select className="w-full px-[14px] py-[10px] font-sans text-sm text-text-primary bg-bg-card border border-border-subtle rounded-[14px] outline-none transition-all focus:border-primary focus:shadow-[0_0_0_3px_var(--navy-brand-light)] placeholder:text-text-muted" id="jabatanSelect" required value={form.jabatan} onChange={(e) => updateField("jabatan", e.target.value)}>
          ...
          <div className="mb-6">
            ...
            <input type="text" className="w-full px-[14px] py-[10px] font-sans text-sm text-text-primary bg-bg-card border border-border-subtle rounded-[14px] outline-none transition-all focus:border-primary focus:shadow-[0_0_0_3px_var(--navy-brand-light)] placeholder:text-text-muted" id="periodeInput" placeholder="Contoh: 2026-2028" required value={form.periode} onChange={(e) => updateField("periode", e.target.value)} />
