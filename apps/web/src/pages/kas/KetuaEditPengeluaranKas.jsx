      ...
      <div className="bg-bg-card rounded-[20px] border border-border-subtle shadow-lux p-10">
        ...
        <form id="pengeluaranForm" noValidate>
          <div className="mb-6">
            ...
            <select className="w-full px-[14px] py-[10px] font-sans text-sm text-text-primary bg-bg-card border border-border-subtle rounded-[14px] outline-none transition-all focus:border-primary focus:shadow-[0_0_0_3px_var(--navy-brand-light)] placeholder:text-text-muted" id="kategoriInput" required value={form.kategori} onChange={(e) => updateField("kategori", e.target.value)}>
          ...
          <div className="mb-6">
            ...
            <input type="date" className="w-full px-[14px] py-[10px] font-sans text-sm text-text-primary bg-bg-card border border-border-subtle rounded-[14px] outline-none transition-all focus:border-primary focus:shadow-[0_0_0_3px_var(--navy-brand-light)] placeholder:text-text-muted" id="tanggalInput" required value={form.tanggal} onChange={(e) => updateField("tanggal", e.target.value)} />
          ...
          <div className="mb-6">
            ...
            <textarea className="w-full px-[14px] py-[10px] font-sans text-sm text-text-primary bg-bg-card border border-border-subtle rounded-[14px] outline-none transition-all focus:border-primary focus:shadow-[0_0_0_3px_var(--navy-brand-light)] placeholder:text-text-muted" id="keteranganInput" placeholder="Deskripsi pengeluaran..." rows="4" required value={form.keterangan} onChange={(e) => updateField("keterangan", e.target.value)}></textarea>
